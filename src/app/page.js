...
export default function Home() {
  return (
    ...
    <div className="flex items-center justify-center text-dark w-full h-[calc(100vh-4rem)] dark:bg-dark dark:text-light ">
      ...
      <div className='flex items-center justify-between w-full  xl:p-24 lg:p-16 md:p-12 sm:p-8 lg:flex-col'>
        <div className='w-1/2 md:w-full'>
          <Image src={ProfilePic} alt='profilePic' className='h-full lg:hidden md:inline-block md:w-full' priority 
        ...
        <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
          ...
          <div className='flex items-center self-start mt-2 lg:self-center'>
            ...
            border-2 border-solid border-transparent hover:border-dark dark:bg-light dark:text-dark dark:hover:bg-dark dark:hover:text-light dark:hover:border-light md:p-2 md:px-4 md:text-base'
            download={true}
