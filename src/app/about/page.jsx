...
const About = () => {
  return (
    <>
    <TransitionEffect/>
    <div className='flex w-full flex-col items-center justify-center dark:text-light dark:bg-dark'>
      <div className='p-14  '>
        <AnimatedText text={"Passion Fuels Purpose!"} className={"mb-16 lg:!text-7xl sm:!6xl xs:!text-4xl sm:!mb-8"} />
        <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
          <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8 '>
            <h2 className='mb-4 text-lg font-bold uppercase text-dark/75 dark:text-light/75 xl:col-span-4 '>Biography</h2>
            <p className='font-medium'>Hi, I'm Mr.Nobody, a web developer and Motion designer with a passion for creating beautiful, functional,
          ...
          <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light dark:border-light dark:bg-dark d p-8 xl:col-span-4 md:order-1 md:col-span-8'>
